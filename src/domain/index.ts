...
export { SCHEMA_VERSION, parseProjectFile, serializeProjectFile, youtubeAudioMeta } from './projectFile';
export type { AudioMeta, ProjectFileData, ProjectFileSource, ProjectInfo } from './projectFile';
