 ...
 * Outbound: full-project zips (uploads), bare project JSON (YouTube, and the
 * community contribution format), and label-set-only JSON. Inbound: zip and
 * JSON imports that can only ever create, and label-set imports gated on
 * recording identity. Built on the domain's versioned project-file format.
 */
